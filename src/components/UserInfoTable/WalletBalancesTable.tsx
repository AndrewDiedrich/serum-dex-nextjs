...
import { useWallet } from '../../utils/WalletSelect'
...
export default function WalletBalancesTable({
  ...
  const columns = [
    {
      ...
      render: (walletBalance) => (
        <Row align="middle">
          <a href={`https://solscan.io/address/${walletBalance.mint}`} target={'_blank'} rel="noopener noreferrer">
  ...
  return (
    <React.Fragment>
      <DataTable emptyLabel="No balances" dataSource={walletBalances} columns={columns} pagination={false} />
      {connected && (
